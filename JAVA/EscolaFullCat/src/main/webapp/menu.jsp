    ...
    <div class="signup">
      ...
      <form method="post" action="AlunoServlet" class="bao">
        ...
        <div class="gamer">
            ...
            <h1 class="titulo2">Busca Aluno Atom</h1>
            <div class="baoDiv">
              <br><label>Matrícula: </label><br><input class="baoText" type="text" value="" id="matricula" name="matricula" value="${aluno.matricula}" placeholder="Digite número de Matrícula."><br>
